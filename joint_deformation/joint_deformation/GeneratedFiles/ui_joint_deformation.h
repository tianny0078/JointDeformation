...
**
** Created: Tue Jul 29 15:13:32 2014
...
public:
    ...
    void setupUi(QMainWindow *joint_deformationClass)
    {
        ...
        pushButton_loadPosConstraint = new QPushButton(centralWidget);
        pushButton_loadPosConstraint->setObjectName(QString::fromUtf8("pushButton_loadPosConstraint"));
    ...
    void retranslateUi(QMainWindow *joint_deformationClass)
    {
        ...
        comboBox_chooseSimulator->insertItems(0, QStringList()
         ...
         << QApplication::translate("joint_deformationClass", "FLSM", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("joint_deformationClass", "Needle_Simulator", 0, QApplication::UnicodeUTF8)
        );
